<script>
import Header from '$lib/Jumbo/Header.svelte'
</script>
<div class="page">
<Header pos="over" />
</div>
...
.page {
  ...
  background-image: linear-gradient(to bottom, rgba(var(--page-bg),0.77), rgba(var(--page-bg),0.33)), url('https://transcribe.newberry.org/ohmekas/themes/papers/asset/img/jumbo-page.webp');
